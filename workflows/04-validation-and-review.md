...
### 🛠️ Context & Tools
- Active Epics, Cards, and **Project-Specific Rules (`.agents/project-rules.md`)**.
...
1.  **Context Ingestion:** Read the active Epic, Card, `.agents/project-rules.md`, and `git-workflow.md` (located in the requirements root).
...
2.  **Context Linking:** Define how the pipeline agent will retrieve the Epic, Card, and `.agents/project-rules.md`.
...
- The review/setup accounts for the project's custom rules (`.agents/project-rules.md`).
